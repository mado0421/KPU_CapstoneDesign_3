...
float3 CalcDiffuse(float3 cLight, float3 cDiff, float3 vToLight, float3 vNormal) { return max(dot(vToLight, vNormal), 0) * cLight * cDiff; }

float3 CalcAmbient(float3 cLight, float3 cDiff) { return cLight * cDiff; }

float CalcAttenuation(float d, float falloffStart, float falloffEnd) { return saturate((falloffEnd - d) / (falloffEnd - falloffStart)); }
...
/*========================================================================
* m �� fresnelFactor�� material ���� �־��ָ� �ȴ�.
* material�� mesh ���� �ø� �� ���� �ø��ų�,,, �̸� ���ص� �������� �ΰ� �װɷ� ���� �ϰų�,,,
* material�� ��� ���ӵ� �������ΰ�? �ؽ�ó? �޽�? ������Ʈ?
* �ؽ�ó�� �÷��ָ� �װ� roughness ���� ��
*=======================================================================*/
