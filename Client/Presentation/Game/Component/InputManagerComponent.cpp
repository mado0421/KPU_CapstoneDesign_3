...
bool InputManagerComponent::IsKeyDown(KeyCode key) { return m_pKeysBuffer[key] & 0xF0; }

bool InputManagerComponent::IsKeyUp(KeyCode key) { return !(m_pKeysBuffer[key] & 0xF0); }

const XMFLOAT2& InputManagerComponent::GetMouseMovement() { return m_xmf2MouseMovement; }
