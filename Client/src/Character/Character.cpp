...
void Character::Damage(int dmg) { m_currHp -= dmg; }

void Character::Die() { m_bDead = true; }
...
int Character::GetCurrHp() { return m_currHp; }

int Character::GetMaxHp() { return m_maxHp; }

float Character::GetCurrHpPerMaxHp() { return m_currHp / m_maxHp * 100; }
