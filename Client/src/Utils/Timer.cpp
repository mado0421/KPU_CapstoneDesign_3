...
Timer::Timer() : m_fTimeElapsed(0), m_nCurrentPerformanceCounter(0), m_bStopped(false)
{
...
float Timer::GetTimeElapsed() { return m_fTimeElapsed; }

float Timer::GetTotalTime()
{
    if (m_bStopped) return static_cast<float>((m_nStopPerformanceCounter - m_nPausedPerformanceCounter - m_nBasePerformanceCounter) * m_fTimeScale);
    return static_cast<float>((m_nCurrentPerformanceCounter - m_nPausedPerformanceCounter - m_nBasePerformanceCounter) * m_fTimeScale);
}
